...
def genrate_random_word():
    ...
    random_no6 = random.randint(1,26)
    random_no7 = random.randint(1,26)
    ...
    random_alpha6 = alpha_list[random_no6]
    random_alpha7 = alpha_list[random_no7]

     
    label1["text"] = random_alpha1+ random_alpha2 + random_alpha3 +  random_alpha4 + random_alpha5 + random_alpha6 + random_alpha7
